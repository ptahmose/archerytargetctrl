...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        // JBL MODIFICATION -> https://github.com/wenzhixin/bootstrap-table/issues/2864
        lastSortOrder: undefined,
        lastSortName: undefined,
...
/*            if(this.options.lastSortOrder === undefined){
        ...
        if (this.options.lastSortName == this.options.sortName &&
             this.options.lastSortOrder=='desc'&&this.options.sortOrder=='asc'){
             this.options.sortName=undefined;
        ...
        this.options.lastSortName=this.options.sortName;
        this.options.lastSortOrder=this.options.sortOrder;  
    };
